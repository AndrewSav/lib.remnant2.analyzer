...
internal static partial class CustomScripts
{
    ...
    public static Dictionary<string, Func<LootItemContext, bool>> Scripts = new()
    {
        ...
        { "Weapon_CrescentMoon", lic => { DreamMaterialLooted(lic, "Quest_Global_NimueDream_C"); return true; } },
        { "Mod_Familiar", lic => { DreamHuntressKilled(lic); return true; } },
        ...
        { "Ring_BandOfTheFanatic", lic => { BandOfTheFanaticLooted(lic); return true; } },
